...
const AIRecommendations = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-[#181818] via-[#232323] to-[#181818] relative overflow-hidden'>
      ...
      <img src="/background_banner.jpg" alt="Banner" className='absolute inset-0 w-full h-full object-cover opacity-20 blur-[2px] pointer-events-none'/>
      {recommendation && recommendation.length > 0 ? (
        <div className='w-full max-w-7xl mx-auto mt-2'>
          <h2 className='text-3xl font-extrabold mb-8 text-left text-white tracking-tight drop-shadow-lg'>Recommendation Movies</h2>
